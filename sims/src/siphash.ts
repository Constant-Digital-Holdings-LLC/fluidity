...
//veorq/SipHash (vectors_sip64). Implemented over BigInt for auditability;
//the wire ceiling is 237 bytes, so clarity outranks throughput by a mile.
//Pure Uint8Array/DataView - no Node imports (Buffer is a Uint8Array).
...
const rotl = (x: bigint, b: bigint): bigint => ((x << b) | (x >> (64n - b))) & MASK64;
...
export const siphash24 = (key: Uint8Array, msg: Uint8Array): Uint8Array => {
    ...
    //final block: remaining bytes little-endian, length (mod 256) in the top byte
