            ...
            if (data[0] === '[') {
                return [
                    ...new LineFormatHelper()
                        .e('RADIO States->', 0)
                        .done,
                    ...this.decode(radioStates, 16, result[1].split(' ')).flatMap((s, index) => s.length ? new LineFormatHelper()
                        .e(`${pLookup(index)}:`, 0)
                        .e(s, 21)
                        .done : [])
                ];
            ...
            if (data[0] === '{') {
                return [
                    ...new LineFormatHelper()
                        .e('PORT States->', 0)
                        .done,
                    ...this.decode(portStates, 16, result[1].split(' ')).flatMap((s, index) => s.length ? new LineFormatHelper()
                        .e(`${pLookup(index)}:`, 0)
                        .e(s, 22)
                        .done : [])
                ];
